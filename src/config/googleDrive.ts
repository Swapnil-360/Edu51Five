...
export const GOOGLE_DRIVE_FOLDERS = {
  ...
  // Course folders with categories separated by exam period
  courses: {
    "CSE-319-20": {
      name: "Networking",
      midterm: {
      ...
      final: {
        "ct-questions": "https://drive.google.com/drive/folders/FINAL_CSE319_CT?usp=drive_link", // Update with your final exam folder
        notes: "https://drive.google.com/drive/folders/FINAL_CSE319_NOTES?usp=drive_link",
        slides: "https://drive.google.com/drive/folders/FINAL_CSE319_SLIDES?usp=drive_link",
        suggestions: "https://drive.google.com/drive/folders/FINAL_CSE319_SUGGESTIONS?usp=drive_link",
        "super-tips": "https://drive.google.com/drive/folders/FINAL_CSE319_SUPERTIPS?usp=drive_link",
        videos: "https://drive.google.com/drive/folders/FINAL_CSE319_VIDEOS?usp=drive_link"
      }
    },
    "CSE-327": {
      ...
      final: {
        "ct-questions": "https://drive.google.com/drive/folders/FINAL_CSE327_CT?usp=drive_link",
        notes: "https://drive.google.com/drive/folders/FINAL_CSE327_NOTES?usp=drive_link",
        slides: "https://drive.google.com/drive/folders/FINAL_CSE327_SLIDES?usp=drive_link",
        suggestions: "https://drive.google.com/drive/folders/FINAL_CSE327_SUGGESTIONS?usp=drive_link",
        "super-tips": "https://drive.google.com/drive/folders/FINAL_CSE327_SUPERTIPS?usp=drive_link",
        videos: "https://drive.google.com/drive/folders/FINAL_CSE327_VIDEOS?usp=drive_link"
      }
    },
    "CSE-407": {
      ...
      final: {
        "ct-questions": "https://drive.google.com/drive/folders/FINAL_CSE407_CT?usp=drive_link",
        notes: "https://drive.google.com/drive/folders/FINAL_CSE407_NOTES?usp=drive_link",
        slides: "https://drive.google.com/drive/folders/FINAL_CSE407_SLIDES?usp=drive_link",
        suggestions: "https://drive.google.com/drive/folders/FINAL_CSE407_SUGGESTIONS?usp=drive_link",
        "super-tips": "https://drive.google.com/drive/folders/FINAL_CSE407_SUPERTIPS?usp=drive_link",
        videos: "https://drive.google.com/drive/folders/FINAL_CSE407_VIDEOS?usp=drive_link"
      }
    },
    "CSE-417": {
      ...
      final: {
        "ct-questions": "https://drive.google.com/drive/folders/FINAL_CSE417_CT?usp=drive_link",
        notes: "https://drive.google.com/drive/folders/FINAL_CSE417_NOTES?usp=drive_link",
        slides: "https://drive.google.com/drive/folders/FINAL_CSE417_SLIDES?usp=drive_link",
        suggestions: "https://drive.google.com/drive/folders/FINAL_CSE417_SUGGESTIONS?usp=drive_link",
        "super-tips": "https://drive.google.com/drive/folders/FINAL_CSE417_SUPERTIPS?usp=drive_link",
        videos: "https://drive.google.com/drive/folders/FINAL_CSE417_VIDEOS?usp=drive_link"
      }
    },
    "CSE-351": {
      ...
      final: {
        "ct-questions": "https://drive.google.com/drive/folders/FINAL_CSE351_CT?usp=drive_link",
        notes: "https://drive.google.com/drive/folders/FINAL_CSE351_NOTES?usp=drive_link",
        slides: "https://drive.google.com/drive/folders/FINAL_CSE351_SLIDES?usp=drive_link",
        suggestions: "https://drive.google.com/drive/folders/FINAL_CSE351_SUGGESTIONS?usp=drive_link",
...
// Helper function to get folder link for a course, category, and exam period
export const getGoogleDriveLink = (courseCode: string, category: string, examPeriod: 'midterm' | 'final' = 'midterm') => {
  ...
  const periodFolders = examPeriod === 'midterm' ? course.midterm : course.final;
  const folderLink = periodFolders[category as keyof typeof periodFolders];
  return folderLink || GOOGLE_DRIVE_FOLDERS.main;
};

// Helper function to get all categories for a course (same for both midterm and final)
export const getCourseCategories = (courseCode: string) => {
  const course = GOOGLE_DRIVE_FOLDERS.courses[courseCode as keyof typeof GOOGLE_DRIVE_FOLDERS.courses];
  return course ? Object.keys(course.midterm) : [];
};
...
// Real file structure for each course, category, and exam period
// This will contain actual file counts and embed URLs for preview
export const getCourseFiles = (courseCode: string, category: string, examPeriod: 'midterm' | 'final' = 'midterm') => {
  // File data separated by exam period
  const courseFiles: Record<string, Record<'midterm' | 'final', Record<string, Array<{id: string, name: string, url: string, embedUrl?: string}>>>> = {
    "CSE-319-20": {
      midterm: {
        "ct-questions": [
      ...
      final: {
        "ct-questions": [
          { id: "cse319_final_ct1", name: "Final CT-1 Questions.pdf", url: "https://drive.google.com/file/d/FINAL_CSE319_CT1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE319_CT1_ID/preview" },
          { id: "cse319_final_ct2", name: "Final CT-2 Questions.pdf", url: "https://drive.google.com/file/d/FINAL_CSE319_CT2_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE319_CT2_ID/preview" },
          // Add more final exam CT questions here
        ],
        "notes": [
          { id: "cse319_final_notes1", name: "Final Exam Notes.pdf", url: "https://drive.google.com/file/d/FINAL_CSE319_NOTES1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE319_NOTES1_ID/preview" },
          // Add more final exam notes here
        ],
        "slides": [
          { id: "cse319_final_slides1", name: "Final Exam Slides.pdf", url: "https://drive.google.com/file/d/FINAL_CSE319_SLIDES1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE319_SLIDES1_ID/preview" },
          // Add more final exam slides here
        ],
        "suggestions": [
          { id: "cse319_final_suggest1", name: "Final Exam Suggestions.pdf", url: "https://drive.google.com/file/d/FINAL_CSE319_SUGGEST1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE319_SUGGEST1_ID/preview" },
          // Add more final exam suggestions here
        ],
        "super-tips": [
          { id: "cse319_final_tips1", name: "Final Exam Super Tips.pdf", url: "https://drive.google.com/file/d/FINAL_CSE319_TIPS1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE319_TIPS1_ID/preview" },
          // Add more final exam super tips here
        ],
        "videos": [
          { id: "cse319_final_video1", name: "Final Exam Video Tutorial", url: "https://drive.google.com/file/d/FINAL_CSE319_VIDEO1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE319_VIDEO1_ID/preview" },
          // Add more final exam videos here
        ]
      }
    },
    "CSE-327": {
      ...
      final: {
        "ct-questions": [
          { id: "cse327_final_ct1", name: "Final CT-1 Questions.pdf", url: "https://drive.google.com/file/d/FINAL_CSE327_CT1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE327_CT1_ID/preview" },
          // Add more final exam CT questions here
        ],
        "notes": [
          { id: "cse327_final_notes1", name: "Final Exam Notes.pdf", url: "https://drive.google.com/file/d/FINAL_CSE327_NOTES1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE327_NOTES1_ID/preview" },
          // Add more final exam notes here
        ],
        "slides": [
          { id: "cse327_final_slides1", name: "Final Exam Slides.pdf", url: "https://drive.google.com/file/d/FINAL_CSE327_SLIDES1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE327_SLIDES1_ID/preview" },
          // Add more final exam slides here
        ],
        "suggestions": [
          { id: "cse327_final_suggest1", name: "Final Exam Suggestions.pdf", url: "https://drive.google.com/file/d/FINAL_CSE327_SUGGEST1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE327_SUGGEST1_ID/preview" },
          // Add more final exam suggestions here
        ],
        "super-tips": [
          { id: "cse327_final_tips1", name: "Final Exam Super Tips.pdf", url: "https://drive.google.com/file/d/FINAL_CSE327_TIPS1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE327_TIPS1_ID/preview" },
          // Add more final exam super tips here
        ],
        "videos": [
          { id: "cse327_final_video1", name: "Final Exam Video Tutorial", url: "https://drive.google.com/file/d/FINAL_CSE327_VIDEO1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE327_VIDEO1_ID/preview" },
          // Add more final exam videos here
        ]
      }
    },
    "CSE-351": {
      ...
      final: {
        "ct-questions": [
          { id: "cse351_final_ct1", name: "Final CT-1 Questions.pdf", url: "https://drive.google.com/file/d/FINAL_CSE351_CT1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE351_CT1_ID/preview" },
          // Add more final exam CT questions here
        ],
        "notes": [
          { id: "cse351_final_notes1", name: "Final Exam Notes.pdf", url: "https://drive.google.com/file/d/FINAL_CSE351_NOTES1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE351_NOTES1_ID/preview" },
          // Add more final exam notes here
        ],
        "slides": [
          { id: "cse351_final_slides1", name: "Final Exam Slides.pdf", url: "https://drive.google.com/file/d/FINAL_CSE351_SLIDES1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE351_SLIDES1_ID/preview" },
          // Add more final exam slides here
        ],
        "suggestions": [
          { id: "cse351_final_suggest1", name: "Final Exam Suggestions.pdf", url: "https://drive.google.com/file/d/FINAL_CSE351_SUGGEST1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE351_SUGGEST1_ID/preview" },
          // Add more final exam suggestions here
        ],
        "super-tips": [
          { id: "cse351_final_tips1", name: "Final Exam Super Tips.pdf", url: "https://drive.google.com/file/d/FINAL_CSE351_TIPS1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE351_TIPS1_ID/preview" },
          // Add more final exam super tips here
        ],
        "videos": [
          { id: "cse351_final_video1", name: "Final Exam Video Tutorial", url: "https://drive.google.com/file/d/FINAL_CSE351_VIDEO1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE351_VIDEO1_ID/preview" },
          // Add more final exam videos here
        ]
      }
    },
    "CSE-407": {
      ...
      final: {
        "ct-questions": [
          { id: "cse407_final_ct1", name: "Final CT-1 Questions.pdf", url: "https://drive.google.com/file/d/FINAL_CSE407_CT1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE407_CT1_ID/preview" },
          // Add more final exam CT questions here
        ],
        "notes": [
          { id: "cse407_final_notes1", name: "Final Exam Notes.pdf", url: "https://drive.google.com/file/d/FINAL_CSE407_NOTES1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE407_NOTES1_ID/preview" },
          // Add more final exam notes here
        ],
        "slides": [
          { id: "cse407_final_slides1", name: "Final Exam Slides.pdf", url: "https://drive.google.com/file/d/FINAL_CSE407_SLIDES1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE407_SLIDES1_ID/preview" },
          // Add more final exam slides here
        ],
        "suggestions": [
          { id: "cse407_final_suggest1", name: "Final Exam Suggestions.pdf", url: "https://drive.google.com/file/d/FINAL_CSE407_SUGGEST1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE407_SUGGEST1_ID/preview" },
          // Add more final exam suggestions here
        ],
        "super-tips": [
          { id: "cse407_final_tips1", name: "Final Exam Super Tips.pdf", url: "https://drive.google.com/file/d/FINAL_CSE407_TIPS1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE407_TIPS1_ID/preview" },
          // Add more final exam super tips here
        ],
        "videos": [
          { id: "cse407_final_video1", name: "Final Exam Video Tutorial", url: "https://drive.google.com/file/d/FINAL_CSE407_VIDEO1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE407_VIDEO1_ID/preview" },
          // Add more final exam videos here
        ]
      }
    },
    "CSE-417": {
      ...
      final: {
        "ct-questions": [
          { id: "cse417_final_ct1", name: "Final CT-1 Questions.pdf", url: "https://drive.google.com/file/d/FINAL_CSE417_CT1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE417_CT1_ID/preview" },
          // Add more final exam CT questions here
        ],
        "notes": [
          { id: "cse417_final_notes1", name: "Final Exam Notes.pdf", url: "https://drive.google.com/file/d/FINAL_CSE417_NOTES1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE417_NOTES1_ID/preview" },
          // Add more final exam notes here
        ],
        "slides": [
          { id: "cse417_final_slides1", name: "Final Exam Slides.pdf", url: "https://drive.google.com/file/d/FINAL_CSE417_SLIDES1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE417_SLIDES1_ID/preview" },
          // Add more final exam slides here
        ],
        "suggestions": [
          { id: "cse417_final_suggest1", name: "Final Exam Suggestions.pdf", url: "https://drive.google.com/file/d/FINAL_CSE417_SUGGEST1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE417_SUGGEST1_ID/preview" },
          // Add more final exam suggestions here
        ],
        "super-tips": [
          { id: "cse417_final_tips1", name: "Final Exam Super Tips.pdf", url: "https://drive.google.com/file/d/FINAL_CSE417_TIPS1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE417_TIPS1_ID/preview" },
          // Add more final exam super tips here
        ],
        "videos": [
          { id: "cse417_final_video1", name: "Final Exam Video Tutorial", url: "https://drive.google.com/file/d/FINAL_CSE417_VIDEO1_ID/view", embedUrl: "https://drive.google.com/file/d/FINAL_CSE417_VIDEO1_ID/preview" },
          // Add more final exam videos here
        ]
      }
    }
  ...
  const periodFiles = course[examPeriod];
  if (!periodFiles) return [];
  
  const files = periodFiles[category];
  return files || [];
};